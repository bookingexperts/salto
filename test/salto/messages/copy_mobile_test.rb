...
module Salto
  module Messages
    class CopyMobileTest < Minitest::Spec
      it 'builds an copy mobile command' do
        now = Time.now

        message =
          Salto::Messages::CopyMobile.new(
        ...
        assert_equal ['CCM', '0612345678', 'Room 1', 'Room 2', 'Room 3', 'Room 4', '12345', '}{_^]', valid_from, valid_till, 'Operator', nil, nil, nil, "John Doe\nAnonymousVille\nGuest"], message.fields
      end
    end
  end
end
